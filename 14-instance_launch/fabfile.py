...
def deploy_cirros():
    ...
    with prefix(credentials):
        ...
        create_image(
            ...
            'qcow2')
        boot_vm('tiny', 'cirros-test0', 'demo_key', 'demo-instance0')
...
def deploy_windows7():
    with prefix(env_config.admin_openrc):
        ...
        create_image(
            ...
            'iso')
        boot_vm('large', 'windows7-test0', 'demo_key', 'windows7-instance0')
...
def deploy_ubuntu():
    with prefix(env_config.admin_openrc):
        ...
        create_image(
            ...
            'qcow2')
        boot_vm('large', 'ubuntu-test0', 'demo_key', 'ubuntu-instance0')
